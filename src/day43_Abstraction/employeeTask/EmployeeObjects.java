...
public class EmployeeObjects {
   ...
   //-> person is abstract class so can not create object

      //  Employee employee = new Employee("Ali", 30, 'M', 42, "SEDT",110000 );
           //-> employee class is abstract class
        ...
        developer.unitTest();
        developer.eat();
       // developer.bugReport(); // bugReport is belong to Tester class, and developer class not inherit from tester class
