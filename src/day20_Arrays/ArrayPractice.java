...
public class ArrayPractice {
    public static void main(String[] args) {
       ...
       /* System.out.println(months[0]); // January
        ...
        System.out.println(months[2]); // January
        System.out.println(months[3]);
        System.out.println(months[4]); // January
        System.out.println(months[5]);
        System.out.println(months[6]); // January
        System.out.println(months[7]);
        System.out.println(months[8]); // January
        System.out.println(months[9]);
        System.out.println(months[10]); // January
